	...
	<div class="card-body">
		...
		<div class="tab-content" id="myTabContent">
			<div class="tab-pane fade show active" id="fileUploader" role="tabpanel" aria-labelledby="fileUploader-tab">
				<form action="<?php echo esc_attr( htmlspecialchars( $this->FM_SELF_URL ) ) . '?page=wp-mastertoolkit-settings-file-manager&p=' . $this->fm_enc( $this->FM_PATH ); ?>" class="dropzone card-tabs-container" id="fileUploader" enctype="multipart/form-data">
