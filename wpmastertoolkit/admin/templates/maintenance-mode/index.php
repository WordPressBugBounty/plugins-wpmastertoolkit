...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo esc_attr( WPMASTERTOOLKIT_PLUGIN_URL . "admin/assets/build/maintenance-mode-template.css" ); ?>">
    <script src="<?php echo esc_attr( WPMASTERTOOLKIT_PLUGIN_URL . "admin/assets/build/maintenance-mode-template.js" ); ?>"></script>
        ...
        <main class="wp-mastertoolkit__main">
            ...
            <div class="wp-mastertoolkit__body">
                ...
                <div class="wp-mastertoolkit__body__description">
                    <?php echo wpautop( esc_textarea( stripslashes( $body_text ) ) ); ?>
                </div>
