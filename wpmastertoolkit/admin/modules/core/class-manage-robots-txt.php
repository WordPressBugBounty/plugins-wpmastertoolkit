...
class WPMastertoolkit_Manage_Robots_Txt {
    ...
    public function render_submenu() {
        ...
        $submenu_assets = include( WPMASTERTOOLKIT_PLUGIN_PATH . 'admin/assets/build/manage-robots-txt.asset.php' );
        wp_enqueue_style( 'WPMastertoolkit_submenu', WPMASTERTOOLKIT_PLUGIN_URL . 'admin/assets/build/manage-robots-txt.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'WPMastertoolkit_submenu', WPMASTERTOOLKIT_PLUGIN_URL . 'admin/assets/build/manage-robots-txt.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
    ...
    private function submenu_content() {
        ...
        ?>
            <div class="wp-mastertoolkit__section">
                <div class="wp-mastertoolkit__section__desc"><?php printf( __( "Easily edit and validate your %s.", 'wpmastertoolkit' ), '<a target="_blank" href="' . site_url( 'robots.txt' ). '">robots.txt</a>' ); ?></div>
