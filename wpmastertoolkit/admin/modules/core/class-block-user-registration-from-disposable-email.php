 ...
 * @since 1.6.0
 */
class WPMastertoolkit_Block_User_Registration_From_Disposable_Email {
    ...
    public function block_user_registration_from_disposable_email( $user_email ){
         ...
         */
        $disposable_emails_domains = apply_filters('wpmastertoolkit/block_user_registration_from_disposable_email/disposable_emails_domains', self::DISPOSABLE_EMAILS_DOMAINS );
