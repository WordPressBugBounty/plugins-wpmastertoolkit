...
class WPMastertoolkit_Revisions_Control {
    ...
    public function render_submenu() {
        ...
        $submenu_assets = include( WPMASTERTOOLKIT_PLUGIN_PATH . 'admin/assets/build/revisions-control.asset.php' );
        wp_enqueue_style( 'WPMastertoolkit_submenu', WPMASTERTOOLKIT_PLUGIN_URL . 'admin/assets/build/revisions-control.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'WPMastertoolkit_submenu', WPMASTERTOOLKIT_PLUGIN_URL . 'admin/assets/build/revisions-control.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
