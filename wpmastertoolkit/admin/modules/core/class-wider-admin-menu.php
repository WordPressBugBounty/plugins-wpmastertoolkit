...
class WPMastertoolkit_Wider_Admin_Menu {
    ...
    public function render_submenu() {
        ...
        $submenu_assets = include( WPMASTERTOOLKIT_PLUGIN_PATH . 'admin/assets/build/wider-admin-menu.asset.php' );
        wp_enqueue_style( 'WPMastertoolkit_submenu', WPMASTERTOOLKIT_PLUGIN_URL . 'admin/assets/build/wider-admin-menu.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'WPMastertoolkit_submenu', WPMASTERTOOLKIT_PLUGIN_URL . 'admin/assets/build/wider-admin-menu.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
